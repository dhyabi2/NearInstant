...
export interface InitOutput {
    ...
    readonly __wbg_browserdkg_free: (a: number, b: number) => void;
    readonly __wbg_browsersigner_free: (a: number, b: number) => void;
    readonly argon2id_raw: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly argon2id_seed: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly atomic_chunk_demo: (a: bigint) => [number, number];
    readonly beacon_account: (a: number, b: number, c: number) => [number, number];
    readonly beacon_address: (a: number, b: number, c: number) => [number, number];
    readonly beacon_decode: (a: number, b: number) => [number, number];
    readonly beacon_encode: (a: number, b: bigint, c: number) => [number, number];
    readonly browserdkg_account: (a: number) => [number, number];
    readonly browserdkg_key_package: (a: number) => [number, number];
    readonly browserdkg_new: (a: number, b: number) => [number, number, number];
    readonly browserdkg_newSeeded: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly browserdkg_public_key_package: (a: number) => [number, number];
    readonly browserdkg_round1_out: (a: number) => [number, number];
    readonly browserdkg_round2_out: (a: number) => [number, number];
    readonly browserdkg_set_peer_round1: (a: number, b: number, c: number) => [number, number];
    readonly browserdkg_set_peer_round2: (a: number, b: number, c: number) => [number, number, number, number];
    readonly browsersigner_account: (a: number) => [number, number, number, number];
    readonly browsersigner_aggregate_presig: (a: number) => [number, number, number, number];
    readonly browsersigner_aggregate_sig: (a: number) => [number, number, number, number];
    readonly browsersigner_new: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly browsersigner_presign_commit: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    readonly browsersigner_presign_share: (a: number) => [number, number, number, number];
    readonly browsersigner_set_peer_commit: (a: number, b: number, c: number) => [number, number];
    readonly browsersigner_set_peer_share: (a: number, b: number, c: number) => [number, number];
    readonly browsersigner_sign_commit: (a: number, b: number, c: number) => [number, number, number, number];
    readonly browsersigner_sign_share: (a: number) => [number, number, number, number];
    readonly engine_version: () => [number, number];
    readonly escrow_selftest: () => [number, number];
    readonly gen_adaptor: () => [number, number];
    readonly gen_identity: () => [number, number];
    readonly make_order: (a: number, b: bigint, c: bigint, d: bigint, e: bigint) => [number, number];
    readonly make_order_seeded: (a: number, b: number, c: number, d: bigint, e: bigint, f: bigint, g: bigint, h: number, i: number) => [number, number];
    readonly make_pof: (a: number, b: number, c: number, d: number, e: bigint, f: bigint, g: bigint) => [number, number];
    readonly make_test_order: (a: bigint) => [number, number];
    readonly nano_address_decode: (a: number, b: number) => [number, number];
    readonly nano_address_encode: (a: number, b: number) => [number, number];
    readonly nano_check: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    readonly pledge_selftest: () => number;
    readonly presig_complete: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly presig_extract: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly presig_verify: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    readonly seed_account: (a: number, b: number) => [number, number];
    readonly sign_state_block: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number];
    readonly state_block_hash: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number];
    readonly work_check: (a: number, b: number, c: bigint, d: bigint) => number;
    readonly work_search: (a: number, b: number, c: bigint, d: bigint, e: bigint) => [number, bigint];
    readonly work_thresholds: () => [number, number];
