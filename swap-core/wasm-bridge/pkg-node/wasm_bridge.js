 ...
 * @returns {Uint8Array}
 */
function argon2id_raw(passphrase, salt, mem_kib) {
...
exports.argon2id_raw = argon2id_raw;
 ...
 * @returns {Uint8Array}
 */
function argon2id_seed(passphrase, salt, mem_kib) {
    const ptr0 = passStringToWasm0(passphrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(salt, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.argon2id_seed = argon2id_seed;
 ...
 * @returns {string}
 */
function atomic_chunk_demo(chunk_raw) {
    let deferred1_0;
    let deferred1_1;
    try {
...
exports.atomic_chunk_demo = atomic_chunk_demo;
 ...
 * @returns {Uint8Array}
 */
function beacon_account(pair, side) {
...
exports.beacon_account = beacon_account;
 ...
 * @returns {string}
 */
function beacon_address(pair, side) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(pair, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
exports.beacon_address = beacon_address;
 ...
 * @returns {string}
 */
function beacon_decode(amount_raw) {
    let deferred2_0;
    let deferred2_1;
    try {
...
exports.beacon_decode = beacon_decode;
 ...
 * @returns {string}
 */
function beacon_encode(side, price_e9, size_log2) {
    let deferred1_0;
    let deferred1_1;
    try {
...
exports.beacon_encode = beacon_encode;
...
exports.escrow_selftest = escrow_selftest;
 ...
 * @returns {Uint8Array}
 */
function gen_adaptor() {
    const ret = wasm.gen_adaptor();
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v1;
}
exports.gen_adaptor = gen_adaptor;
...
exports.gen_identity = gen_identity;
 ...
 * @returns {string}
 */
function make_order(side, amount_milli_xno, rate_micro, nonce, now_secs) {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {string}
 */
function make_order_seeded(seed_hex, side, amount_milli_xno, rate_micro, nonce, now_secs, pof_hash_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
...
exports.make_order_seeded = make_order_seeded;
 ...
 * @returns {string}
 */
function make_pof(seed_hex, amount_raw, as_of_block, expires, nonce) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(seed_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
function make_test_order(now_secs) {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {Uint8Array}
 */
function nano_address_decode(addr) {
...
exports.nano_address_decode = nano_address_decode;
 ...
 * @returns {string}
 */
function nano_address_encode(public_key) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {boolean}
 */
function nano_check(account, message, signature) {
 ...
 * @returns {boolean}
 */
function pledge_selftest() {
    const ret = wasm.pledge_selftest();
    return ret !== 0;
}
exports.pledge_selftest = pledge_selftest;
 ...
 * @returns {Uint8Array}
 */
function presig_complete(presig, secret) {
...
exports.presig_complete = presig_complete;
 ...
 * @returns {Uint8Array}
 */
function presig_extract(presig, signature) {
    const ptr0 = passArray8ToWasm0(presig, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.presig_extract = presig_extract;
 ...
 * @returns {boolean}
 */
function presig_verify(presig, account, message) {
    const ptr0 = passArray8ToWasm0(presig, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.presig_verify = presig_verify;
 ...
 * @returns {string}
 */
function seed_account(seed_hex) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(seed_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
exports.seed_account = seed_account;
 ...
 * @returns {string}
 */
function sign_state_block(seed_hex, previous_hex, representative_hex, balance_raw, link_hex, subtype) {
    let deferred7_0;
    let deferred7_1;
    try {
        const ptr0 = passStringToWasm0(seed_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
exports.sign_state_block = sign_state_block;
 ...
 * @returns {Uint8Array}
 */
function state_block_hash(account_hex, previous_hex, representative_hex, balance_raw, link_hex, subtype) {
...
exports.state_block_hash = state_block_hash;
...
exports.work_thresholds = work_thresholds;
